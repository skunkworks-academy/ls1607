# GitHub Achievements Academy — Evidence Register

**Assignee:** [@Luca-Sprunt](https://github.com/Luca-Sprunt)  
**Tracking issue:** [#15](https://github.com/skunkworks-academy/ls1607/issues/15)

Use this register to record legitimate public evidence from the learning activity. Do not include private links, credentials, personal data or confidential repository information.
...
- [ ] Navigated an external GitHub learning repository
- [ ] Followed a documented task workflow
- [ ] Used an issue to track work
...
- [ ] No spam or artificial engagement was created.
- [ ] No unrelated users were tagged or involved without consent.
- [ ] No credentials, secrets or personal information are present.
- [ ] All links are appropriate for public review.
- [ ] Reflection and evidence accurately represent the work completed.
